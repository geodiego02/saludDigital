    ...
    <section class="section">
        ...
        <div class="articulos">
            <div class="articulo">
                ...
                <form action="<?php echo constant('URL').'paciente/ConsultarHorasDiaId'; ?>" method="POST">
                ...
                <?php
                    if($this->arreglo!=null){
                        ...
                        $cuenta=$this->arreglo[2];
                        $i=0;
                        while($i<$cuenta){
                            echo '<tr>';
                                echo '<th>'.$this->arreglo[0][$i].'   -</th>';
                                echo '<th>'.$this->arreglo[1][$i].'   -</th>';
                                echo '<th>'.$this->arreglo[3][$i].'   -</th>';
                            echo '</tr>';
                            $i++;
                        }
                    }
